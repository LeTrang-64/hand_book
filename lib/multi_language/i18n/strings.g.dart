...
///
/// Original: lib/multi_language/i18n
/// To regenerate, run: `dart run slang`
///
/// Locales: 2
/// Strings: 16 (8 per locale)
///
/// Built on 2024-04-11 at 10:46 UTC
...
class _StringsMainScreenEn {
	...
	late final _StringsMainScreenCounter2En counter2 = _StringsMainScreenCounter2En._(_root);
	String get tapMe => 'Tap me';
}

// Path: mainScreen.counter2
class _StringsMainScreenCounter2En {
	_StringsMainScreenCounter2En._(this._root);

	final Translations _root; // ignore: unused_field

	// Translations
	String me({required num n, required Object name}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
		one: 'You pressed ${name} time.',
	);
	String other({required Object n}) => 'You pressed ${n} times.';
}
...
class _StringsMainScreenDe implements _StringsMainScreenEn {
	...
	@override late final _StringsMainScreenCounter2De counter2 = _StringsMainScreenCounter2De._(_root);
	@override String get tapMe => 'Drück mich';
}

// Path: mainScreen.counter2
class _StringsMainScreenCounter2De implements _StringsMainScreenCounter2En {
	_StringsMainScreenCounter2De._(this._root);

	@override final _StringsDe _root; // ignore: unused_field

	// Translations
	@override String me({required num n, required Object name}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('de'))(n,
		one: 'You pressed ${name} time.',
	);
	@override String other({required Object n}) => 'You pressed ${n} times.';
}
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'mainScreen.counter2.me': return ({required num n, required Object name}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
				one: 'You pressed ${name} time.',
			);
			case 'mainScreen.counter2.other': return ({required Object n}) => 'You pressed ${n} times.';
...
extension on _StringsDe {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'mainScreen.counter2.me': return ({required num n, required Object name}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('de'))(n,
				one: 'You pressed ${name} time.',
			);
			case 'mainScreen.counter2.other': return ({required Object n}) => 'You pressed ${n} times.';
